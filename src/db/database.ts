...
export class DataLensDatabase extends Dexie {
  ...
  constructor() {
    ...
    this.version(1).stores({
      ...
      // Conversations
      conversations: '++id, title, databaseId, createdAt, updatedAt, messageCount',
    ...
    this.databaseInfo.hook('updating', (modifications: Partial<DatabaseInfo>, primKey, obj, trans) => {
    ...
    this.conversations.hook('updating', (modifications: Partial<Conversation>, primKey, obj, trans) => {
      modifications.updatedAt = new Date();
    });
    ...
    this.schemaInfo.hook('updating', (modifications: Partial<SchemaInfo>, primKey, obj, trans) => {
      modifications.updatedAt = new Date();
    });
    ...
    this.userSettings.hook('updating', (modifications: Partial<UserSettings>, primKey, obj, trans) => {
      modifications.updatedAt = new Date();
    });
  }
